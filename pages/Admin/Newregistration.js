                            ...
                            <div className="col-span-2">
                                <div className="mb-4 flex">
                                    <input
                                        ...
                                        className="w-24 mr-2 py-2 px-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    />
                                    <input
                                        type="text"
                                        name="middleName"
                                    ...
                                    <input
                                        ...
                                        className="w-24 py-2 px-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                                    />
                                </div>
