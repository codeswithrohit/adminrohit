  ...
  <table  className="w-full border-collapse border border-gray-300 mb-4">
    <thead>
      <tr className="bg-gray-200">
        <th className="border text-[10px] border-gray-300 px-1 py-1">Student Name</th>
        <th className="border text-[10px] border-gray-300 px-1 py-1">Contact Details</th>
        <th className="border text-[10px] border-gray-300 px-1 py-1">Remain</th>
